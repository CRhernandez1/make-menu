...
def _get_manager_est_ids(user):
    """Devuelve una lista plana con los IDs de establecimientos donde el usuario ejerce como manager."""
    return list(
        user.manages.filter(role='manager', end_date__isnull=True).values_list(
