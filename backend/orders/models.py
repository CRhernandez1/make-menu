...
class OrderDetail(models.Model):
    order = models.ForeignKey('orders.Order', related_name='details', on_delete=models.CASCADE)
    product = models.ForeignKey('products.Product', related_name='sales', on_delete=models.PROTECT)
