...
urlpatterns = [
    ...
    path(
        'waiter/tables/<int:table_num>/order/', views.waiter_table_order, name='waiter-table-order'
    ),
    path(
        'waiter/tables/<int:table_num>/close/', views.waiter_close_table, name='waiter-close-table'
    ),
    path(
        'waiter/orders/<int:order_id>/advance/',
        views.waiter_advance_order,
        name='waiter-advance-order',
    ),
    path(
        'waiter/orders/<int:order_id>/cancel/',
        views.waiter_cancel_order,
        name='waiter-cancel-order',
    ),
    # Kitchen
    path('kitchen/orders/', views.kitchen_active_orders, name='kitchen-active-orders'),
    path(
        'kitchen/orders/<int:order_id>/advance/',
        views.kitchen_advance_order,
        name='kitchen-advance-order',
    ),
    path(
        'kitchen/orders/<int:order_id>/complete/',
        views.kitchen_complete_order,
        name='kitchen-complete-order',
    ),
    path(
        'kitchen/items/<int:item_id>/toggle/', views.kitchen_toggle_item, name='kitchen-toggle-item'
    ),
    # Público
